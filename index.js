...
app.get('/mark-found', async (req, res) => {
  ...
  try {
    ...
    const pages = await axios.get(`https://${SHOPIFY_SHOP}.myshopify.com/admin/api/2023-10/pages.json?handle=${handle}`, {
      headers: {
    ...
    // Update metafield
    await axios.put(`https://${SHOPIFY_SHOP}.myshopify.com/admin/api/2023-10/pages/${page.id}/metafields.json`, {
      metafield: {
        namespace: "custom",
        key: "lost_status",
        type: "boolean",
